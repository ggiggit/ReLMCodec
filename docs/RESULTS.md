...
The full command exited **0** and wrote **5,559 reconstruction WAVs** plus a result JSON with **5,559 per-file entries**. Log-Mel, PESQ-wb, and STOI each have **5,559 valid values**, with no PESQ/STOI errors. The rerun means were Log-Mel **1.287122302538715**, PESQ-wb **2.3715504134252443**, and STOI **0.9158549122489322**. All **5,559 per-file metric triples** match the published [64K JSON](results/reproduced_64k.json) exactly. The tested weight was the published inference file with SHA-256 `951abb8e1b8af372c963b9ca360c3246ee9ed255a6c0f251018fe3223846231a`; it was linked from the existing local copy to avoid a second 3.1 GB download. This recheck covers the three core reconstruction metrics in the README command. WER, speaker similarity, and UTMOS require the separate evaluators described in [EVALUATION.md](EVALUATION.md) and were not part of this command.
